...
// List all tasks endpoint
    ...
    @DeleteMapping("")
    public void deleteTask(@RequestParam(required = false) Integer taskId,
...
boolean flag = false;
        ...
        if(flag)
            throw new ResponseStatusException(HttpStatus.FOUND, "Task removed successfully.");
        else
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "No Task found to remove");
